        ...
        return (React.createElement("section", { className: "".concat(styles.teamAssistant, " ").concat(hasTeamsContext ? styles.teams : '') },
            React.createElement("div", { className: styles.welcome },
                React.createElement("h2", null,
                    ...
                    "!"),
                React.createElement(TeamMembers, { description: this.props.description, isDarkTheme: this.props.isDarkTheme, environmentMessage: this.props.environmentMessage, hasTeamsContext: this.props.hasTeamsContext, userDisplayName: this.props.userDisplayName, context: this.props.context }))));
    };
